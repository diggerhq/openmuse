...
- `docs/` `ui.md`, `evidence.md`, `improvements.md`, `deploy/<host>.md`; `e2e/` Playwright; `test/` Vitest
...
The design record is the OpenMuse product note in the private
serverless-agents workspace; the public contracts are the OpenComputer docs
on memory, sessions, events and the management API. What has run, with
session ids, is `docs/evidence.md`; what should change, and what would
delete which code, is `docs/improvements.md`.
